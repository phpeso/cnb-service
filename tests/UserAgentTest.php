...
final class UserAgentTest extends TestCase
{
    public function testUserAgent(): void
    {
        ...
        self::assertEquals("Peso/$pesoVersion CNB-Client/$clientVersion", $request->getHeaderLine('User-Agent'));
    }
    ...
    public function testCustomUserAgent(): void
    {
        ...
        self::assertEquals(
            "Peso/$pesoVersion CNB-Client/$clientVersion CustomSuffix/1.0",
